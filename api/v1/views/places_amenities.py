#!/usr/bin/python3
"""flask api handling requests for the link between place and amenity objects
"""
...
def amenities_per_place(place_id=None):
    """This route handles requests of amenities by a place"""
...
def amenity_to_place(place_id=None, amenity_id=None):
    """reviews route to handle http methods for given amenity by ID"""
    place_obj = storage.get('Place', place_id)
